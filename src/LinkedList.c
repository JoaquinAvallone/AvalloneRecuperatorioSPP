...
/// @brief Devuelve un nueov Linkedlist cargado con los elementos que pasan la funcion filtro
///
/// @param this LinkedList* likedlist a filtrar
/// @param int (*pFunc) (void*) puntero a la funcion q filtra
